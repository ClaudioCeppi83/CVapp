...
const lang_data = {
	es: {
		...
		dev_proj_7_tag: "Recetario Fullstack / Cocina Italiana",
		dev_proj_7_title: "Italia: Sabor & Nostalgia",
		dev_proj_7_desc: "Plataforma editorial gastronómica con capa de resiliencia híbrida, motor interactivo de sustituciones saludables y marcado Schema.org Recipe.",
		dev_proj_7_link: "Ver Proyecto en Vivo",
		dev_proj_5_tag: "GastroTech Multilingüe / Menú Digital",
		dev_proj_5_title: "D'Alesso — Cucina Pura",
		dev_proj_5_desc: "Menú digital gastronómico consciente con soporte multilingüe en 3 idiomas (ES/EN/IT), panel metabólico bottom-sheet y SEO internacional con hreflang.",
		dev_proj_5_link: "Ver Proyecto en Vivo",
		dev_proj_6_tag: "Motor Python / Portal Editorial Afiliados",
		dev_proj_6_title: "GRADO — Espresso Authority",
		dev_proj_6_desc: "Portal editorial y generador estático en Python para cafeteras espresso de alta gama. Búsqueda y filtrado en tiempo real, microdatos Schema.org y cumplimiento FTC.",
		dev_proj_6_link: "Ver Proyecto en Vivo",
		...
		dev_proj_4_desc: "Motor de buffer de texto bidimensional implementado en Python con gestión de cursores, historial de deshacer/rehacer y suite de 20 pruebas unitarias.",
		dev_proj_4_link: "Ver Repositorio",
		dev_proj_8_tag: "Flutter Mobile / Google Maps",
		dev_proj_8_title: "Geo Alarm (Android / iOS)",
		dev_proj_8_desc: "App móvil de alarmas geográficas por geocercas GPS con Google Maps, persistencia local-first, ahorro de batería adaptativo y buscador de direcciones multicapa.",
		dev_proj_8_link: "Ver en GitHub",
		dev_proj_9_tag: "Linux Desktop / GTK3 & Python",
	...
	en: {
		...
		dev_proj_7_tag: "Fullstack Recipe Platform / Italian Cuisine",
		dev_proj_7_title: "Italia: Sabor & Nostalgia",
		dev_proj_7_desc: "Editorial gastronomy platform featuring hybrid data resilience, interactive healthy substitution engine, and Schema.org Recipe rich graph.",
		dev_proj_7_link: "View Live Project",
		dev_proj_5_tag: "Multilingual GastroTech / Digital Menu",
		dev_proj_5_title: "D'Alesso — Pure Cuisine",
		dev_proj_5_desc: "Conscious gastronomy digital menu with 3-language support (ES/EN/IT), metabolic bottom-sheet intelligence, and international hreflang SEO.",
		dev_proj_5_link: "View Live Project",
		dev_proj_6_tag: "Python Engine / Editorial Affiliate",
		dev_proj_6_title: "GRADO — Espresso Authority",
		dev_proj_6_desc: "High-end espresso machine affiliate authority portal powered by a Python static compiler. Features real-time filtering, Schema.org ItemList markup, and FTC compliance.",
		dev_proj_6_link: "View Live Project",
		dev_proj_3_tag: "Python CLI & Web GUI",
		dev_proj_3_title: "Expense Tracker CLI",
		...
		dev_proj_4_tag: "Core Engine / Data Structures",
		dev_proj_4_title: "Text Editor Core",
		dev_proj_4_desc: "2D text buffer engine written in Python featuring coordinate-based cursor management, undo/redo history, and a 20 unit-test suite.",
		dev_proj_4_link: "View Repository",
		dev_proj_8_tag: "Flutter Mobile / Google Maps",
		dev_proj_8_title: "Geo Alarm (Android / iOS)",
		dev_proj_8_desc: "Mobile geofencing alarm app in Flutter with Google Maps, local-first offline persistence, adaptive battery tracking, and multi-tiered address search.",
		dev_proj_8_link: "View on GitHub",
		dev_proj_9_tag: "Linux Desktop / GTK3 & Python",
		dev_proj_9_title: "Agente Resources KPI",
